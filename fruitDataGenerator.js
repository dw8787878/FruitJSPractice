...
/**
    Given sequence of fruits [10,000]
    {
        DayNumber
        Name,
        Region,
    ...
    Assume we have 360 days per year, 30 days per month, 12 months
    Assume a region corresponds to a continent of origin
    Assume things are 0 indexed
 */
...
debugger;
console.log(JSON.stringify(flattenedFruitRecords));
const _fruitPrototype = {
    Day: 0,
    Name: "",
    Region: "",
    Price: 0.0
